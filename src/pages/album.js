...
const Album = () => {
    ...
    const [dataToAccess, setDataToAccess] = useState(null);
        ...
        <><section className="content">
            <div className="container-fluid">
                <AddAlbum 
                   onCreate={onCreate} 
                   onDelete={onDelete} 
                   dataToAccess={dataToAccess} 
                   setDataToAccess={setDataToAccess} 
                />
                {loading && <Loader />}
                {error && (
                  <Message
                  ...
                  />)}
                  {db && (
                      <DataAlbum data={db}  dataToAccess={dataToAccess}  onDelete={onDelete} />
                  )}
            </div>
